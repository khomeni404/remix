...
public class HomeController {
    ...
    @RequestMapping(value = "/top_menu.ibbl")
    public ModelAndView top_menu(@RequestParam(required = false) String message) {
        Map<String, Object> modelMap = ActionUtil.getModelMap("TAIMS Home");
        modelMap.put("message", GenericValidator.isBlankOrNull(message) ? "Welcome  Home !" : message);
        return new ModelAndView("home/template/top_menu", modelMap);
    }
