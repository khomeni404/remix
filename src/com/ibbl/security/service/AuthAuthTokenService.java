...
public class AuthAuthTokenService implements AuthorizationService {
    ...
    public ActionResult casmAuthenticate(AuthenticationBean authBean) {
        ...
        try {
            ...
            if (securitySessionBean != null) {
                ...
                if (userBean != null) {
                    ...
                    if (loggedUser == null) {
                        ...
                        newLoggedUser.setLastLogin(today);
                        newLoggedUser.setLastUpdate(today);
                         ...
                         */
                        Date lastUpdate = loggedUser.getLastUpdate();
                        if (DateUtil.getDayDifference(lastUpdate, today) > 30) {
                            loggedUser.setName(userDetail.getFullName());
                            loggedUser.setCurrentDesignation(userDetail.getCurrentDesignation());
                            loggedUser.setLastUpdate(today);
                        }
                        loggedUser.setLastLogin(today);
            ...
            e.printStackTrace();
            result.setMsg(Utility.getMessage(e)+" | Location: "+this.getClass().getName());
        }
        return result;
    }
    ...
    public void setAuthorizationToken(List<PrivilegeBean> privilegeBeanList) {
        ...
        if (CollectionUtils.isEmpty(privilegeBeanList)) {
            ...
            Set<String> grantedMappings = securityDAO.findAllActionMapping(privilegeIDList);
    ...
    public Action checkAuthorizationUsingAction(String mapping) {
        Set<Action> actions = SessionUtil.getSessionUsersActions();
