...
public interface SecurityConstants {
    ...
    String SESSION_USER_CASM_OID = "session_user_casm_oid";
    String SESSION_USER_CASM_USER_ID = "session_user_username";
    String SESSION_USER_GRANTED_ACTIONS = "session_user_actions";
    String SESSION_USER_GRANTED_MAPPINGS = "session_user_actions_mappings";
