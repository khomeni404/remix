...
<div class="row">
    <form action="${ctx}/test/saveIncident.ibbl" method="POST" class="form-horizontal" role="form">
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <input name="${spring.status.expression}" value="${spring.status.value?html}" type="text" id="refNo" placeholder=""
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="type" class="chosen-select form-control" id="incident-type"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group"><span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span>
                        <@spring.bind "incident.incidentDate"/>
                        <input name="${spring.status.expression}" value="02/10/2017" class="date-picker  col-sm-4" id="incident-date"
                               type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group"><span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span>
                        <input name="reportingDate" value="${reportingDate?string('dd/MM/yyyy')}"
                               class="date-picker  col-sm-4" id="id-date-picker-1" type="text"
                               data-date-format="mm/dd/yyyy"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input name="lossAmt" type="number" value="125400" id="loss-amt" placeholder="Text Field"
                           class=" col-sm-5"/>
                </div>
            </div>
        ...
        <div class="col-xs-6">
            ...
            <div class="form-group">
                <div class="col-sm-9">
                    <div class="inline">
                        <div class="checkbox">
                            <label class="">
                                <input name="noControllingApparatus" class="ace ace-checkbox-2 <#--input-lg-->"
                                       type="checkbox" onclick="$('.control-already-exists').toggle()"/>
                                <span class="lbl"> <b>Preventative Control did not exists</b></span>
                            </label>
                        </div>
            ...
            <div class="form-group control-already-exists">
                <label class="col-sm-12 control-label" for="failure-reasons">Control Details</label>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-12 control-label" for="preventative-controls">Preventative Controls Employed for
                    Future Re-occurrence</label>
            </div>

            <div class="form-group">
                <div class="col-sm-12">
                    <textarea name="preventativeControls" id="preventative-controls"
                              class="autosize-transition form-control">This controls has been employed. Do u like it !</textarea>
